...
export default {
  async fetch(request, env) {
    ...
    // Clean HTML: remove BabyLoveGrowth attribution link and hero image duplicate
    let html = content_html || "";

    // Remove "Article generated by BabyLoveGrowth" link
    html = html.replace(/<p>\s*<a[^>]*babylovegrowth[^>]*>.*?<\/a>\s*<\/p>/gi, "");

    // Remove first <img> that matches the hero image URL (appears duplicated at top of content)
    if (heroImageUrl) {
