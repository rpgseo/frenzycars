---
title: '2025 Porsche 911 GT3 RS Review: Price, Top Speed, and Track Performance'
...
description: 'The 2025 Porsche 911 GT3 RS starts at $241,300, hits 184 mph, and redefines what a road-legal track weapon can be — full review, specs, and verdict.'
featured: true
rating: 9.6
...
specs:
  ...
  - label: 'Torque'
    value: '343 lb-ft @ 6,300 rpm'
  - label: '0-60 mph'
    value: '2.9 seconds'
  - label: 'Top speed'
    value: '184 mph (296 km/h)'
  - label: 'Weight'
    value: '3,268 lbs (1,483 kg)'
  - label: 'Downforce'
    value: '900 kg at 177 mph (285 km/h)'
  - label: 'Starting price (MSRP)'
    value: '$241,300'
pros:
  - 'Naturally aspirated 4.0L flat-six with no turbo lag and an 8,500 rpm redline'
  - 'Active aerodynamics generate genuine downforce, not just visual drama'
  - 'Steering and chassis feedback rival purpose-built track cars'
  - 'Adjustable DRS-style rear wing meaningfully changes handling character'
cons:
  - 'Ride quality is uncompromising — not built for daily commuting'
  - 'Options and ceramic brakes push the as-tested price well past $300,000'
  - 'Limited rear visibility due to the fixed wing and engine cover'
verdict: 'If you want luxury, look elsewhere. If you want the purest naturally aspirated driving instrument short of a purpose-built racer, the GT3 RS is the benchmark other track-focused cars are measured against.'
dimensions:
  - label: 'Performance'
    score: 10
  - label: 'Handling'
